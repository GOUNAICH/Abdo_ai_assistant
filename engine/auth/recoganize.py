...
def AuthenticateFace(user_id=1):  # Default user ID is 1
    ...
    # Load trained model
    recognizer.read('C:\\Users\\dell\\Desktop\\Abdo_ai_assistant\\engine\\auth\\trainer\\trainer.yml')  

    # Load Haar Cascade for face detection
    cascadePath = "C:\\Users\\dell\\Desktop\\Abdo_ai_assistant\\engine\\auth\\haarcascade_frontalface_default.xml"
